...
#endif
#if !defined(MBED_CONF_NORDIC_NRF_LF_CLOCK_CALIB_MODE_CONFIG)
	#define MBED_CONF_NORDIC_NRF_LF_CLOCK_CALIB_MODE_CONFIG (0)
#endif
...
#endif
#if !defined(MBED_CONF_NORDIC_UART_HWFC)
...
#endif
#if !defined(MBED_CONF_NORDIC_NRF_LF_CLOCK_SRC)
...
#endif
#if !defined(MBED_CONF_NORDIC_NRF_LF_CLOCK_CALIB_TIMER_INTERVAL)
