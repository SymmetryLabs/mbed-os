...
#endif
#if !defined(MBED_CONF_TARGET_CTRL01_ENABLE)
	#define MBED_CONF_TARGET_CTRL01_ENABLE (0)
#endif
...
#endif
#if !defined(MBED_CONF_TARGET_USB_DEVICE_HSUSBD)
	#define MBED_CONF_TARGET_USB_DEVICE_HSUSBD (1)
#endif
